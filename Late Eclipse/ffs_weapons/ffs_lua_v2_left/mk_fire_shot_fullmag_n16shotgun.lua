...
function GunFire:draw()
  ...
  activeItem.setCursor("/cursors/mk_reticle_normal_n16shotgun.cursor")
...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/mk_reticle_aim_n16shotgun.cursor")
  ...
  activeItem.setCursor("/cursors/mk_reticle_fire_n16shotgun.cursor")
  self:fireProjectile()
  animator.setParticleEmitterActive("smoke_end", true)
  animator.setParticleEmitterActive("ember", true)
  animator.playSound("firePump_fire")
  ...
  activeItem.setCursor("/cursors/mk_reticle_release_n16shotgun.cursor")
  ...
  animator.playSound("firePump_1")
  self:fireProjectile("ffs_shotshell_pump_start")
  ...
  util.wait(self.fireTime - (self.stances.motion1.duration + self.stances.motion2.duration + self.stances.motion3.duration + self.stances.motion4.duration + self.stances.motion5.duration + self.stances.motion6.duration + self.stances.motion7.duration + self.stances.motion8.duration + self.stances.motion9.duration + self.stances.motion10.duration))  
  ...
  status.modifyResource("energy", self:energyPerShot())
  local progress = 0
  ...
  util.wait(self.stances.reloadmotion10.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion10.weaponRotation, self.stances.idle.weaponRotation))
    self.weapon.relativeArmRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion10.armRotation, self.stances.idle.armRotation))
