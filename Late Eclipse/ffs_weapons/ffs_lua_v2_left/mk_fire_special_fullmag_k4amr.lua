...
function GunFire:draw()
  ...
  activeItem.setCursor("/cursors/mk_normal_k4amr.cursor")
...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/mk_reticle10_k4amr_aim.cursor")
  ...
  activeItem.setCursor("/cursors/mk_reticle10_k4amr.cursor")
  ...
  animator.setParticleEmitterActive("ember", false)
  status.addEphemeralEffect("ffs_concentration")
  activeItem.setCursor("/cursors/mk_reticle10_k4amr_release.cursor")
