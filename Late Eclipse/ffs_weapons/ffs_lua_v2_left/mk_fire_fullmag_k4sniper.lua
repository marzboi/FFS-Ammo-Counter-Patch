...
function GunFire:draw()
  ...
  activeItem.setCursor("/cursors/mk_normal_k4sniper.cursor")
...
function GunFire:auto()
  ...
  local progress = 0
  activeItem.setCursor("/cursors/mk_reticle10_k4sniper_aim.cursor")
  ...
  activeItem.setCursor("/cursors/mk_reticle10_k4sniper.cursor")
  self:fireProjectile()
  ...
  status.addEphemeralEffect("ffs_concentration")
  activeItem.setCursor("/cursors/mk_reticle10_k4sniper_release.cursor")
  ...
  util.wait(self.stances.motion5.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.motion5.weaponRotation, self.stances.motion1.weaponRotation))
    self.weapon.relativeArmRotation = util.toRadians(interp.linear(progress, self.stances.motion5.armRotation, self.stances.motion1.armRotation))

    progress = math.min(1.0, progress + (self.dt / self.stances.motion5.duration))
  end)  
  util.wait(self.fireTime - (self.stances.motion2.duration + self.stances.motion3.duration + self.stances.motion4.duration + self.stances.motion5.duration))
  end
