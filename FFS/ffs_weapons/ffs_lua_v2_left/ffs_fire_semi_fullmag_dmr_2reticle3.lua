...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_2reticle3_aim.cursor")
  local progress = 0
  ...
  status.addEphemeralEffect("ffs_concentration")
  activeItem.setCursor("/cursors/ffs_2reticle3.cursor")
  self:fireProjectile()
  ...
  activeItem.setCursor("/cursors/ffs_2reticle3_release.cursor")
  status.addEphemeralEffect("ffs_concentration")
  ...
  util.wait(self.fireTime - (self.stances.motion1.duration + self.stances.motion2.duration + self.stances.motion3.duration + self.stances.motion4.duration))  
  end
