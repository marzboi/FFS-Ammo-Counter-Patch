...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle4_aim.cursor")
  local progress = 0
  ...
  activeItem.setCursor("/cursors/ffs_reticle4.cursor")
  self:fireProjectile()
  ...
  activeItem.setCursor("/cursors/ffs_reticle4_release.cursor")
