...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle6_aim.cursor")
  local progress = 0
  ...
  status.addEphemeralEffect("ffs_concentration")
  activeItem.setCursor("/cursors/ffs_reticle6.cursor")
  self:fireProjectile()
  ...
  activeItem.setCursor("/cursors/ffs_reticle6_release.cursor")
  status.addEphemeralEffect("ffs_concentration")
