...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle3_aim.cursor")
  local progress = 0
  ...
  status.addEphemeralEffect("ffs_concentration")
  activeItem.setCursor("/cursors/ffs_reticle3.cursor")
  self:fireProjectile()
  ...
  activeItem.setCursor("/cursors/ffs_reticle3_release.cursor")
  status.addEphemeralEffect("ffs_concentration")
