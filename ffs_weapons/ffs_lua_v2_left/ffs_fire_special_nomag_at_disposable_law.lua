...
function GunFire:reload()
  ...
  util.wait(self.stances.reloadmotion1.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion1
      .weaponRotation, self.stances.reloadmotion2.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion2.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion2
      .weaponRotation, self.stances.reloadmotion3.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion3.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion3
      .weaponRotation, self.stances.reloadmotion4.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion4.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion4
      .weaponRotation, self.stances.reloadmotion5.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion5.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion5
      .weaponRotation, self.stances.reloadmotion6.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion6.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion6
      .weaponRotation, self.stances.reloadmotion7.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion7.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion7
      .weaponRotation, self.stances.reloadmotion8.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion8.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion8
      .weaponRotation, self.stances.reloadmotion9.weaponRotation))
  ...
  util.wait(self.stances.reloadmotion9.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.reloadmotion9
      .weaponRotation, self.stances.reloadmotion10.weaponRotation))
