...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle9_aim.cursor")
  ...
  activeItem.setCursor("/cursors/ffs_reticle9.cursor")
  ...
  activeItem.setCursor("/cursors/ffs_reticle9_release.cursor")
  status.addEphemeralEffect("ffs_concentration")
