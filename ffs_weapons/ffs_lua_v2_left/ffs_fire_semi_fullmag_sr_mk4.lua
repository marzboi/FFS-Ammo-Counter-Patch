...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle10_aim.cursor")
  ...
  status.addEphemeralEffect("ffs_concentration")
  status.addEphemeralEffect("ffs_snipe")
  activeItem.setCursor("/cursors/ffs_reticle10.cursor")
  self:fireProjectile()
  ...
  activeItem.setCursor("/cursors/ffs_reticle10_release.cursor")
  status.addEphemeralEffect("ffs_concentration")
  status.addEphemeralEffect("ffs_snipe")
