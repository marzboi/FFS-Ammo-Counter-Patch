...
function GunFire:draw20()
  ...
  activeItem.setCursor("/cursors/ffs_reticle_reload_shot.cursor")
...
function GunFire:auto()
  ...
  util.wait(self.fireTime - self.stances.fire.duration)
  ...
  self:fireProjectile()
  animator.playSound("fireShot_fire")
