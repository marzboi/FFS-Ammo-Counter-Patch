...
function GunFire:draw()
  ...
  activeItem.setCursor("/cursors/ffs_reticle_dot.cursor")
...
function GunFire:auto()
  ...
  activeItem.setCursor("/cursors/ffs_reticle_aim_dot.cursor")
  ...
  activeItem.setCursor("/cursors/ffs_reticle_fire_dot.cursor")
  ...
  activeItem.setCursor("/cursors/ffs_reticle_release_dot.cursor")
