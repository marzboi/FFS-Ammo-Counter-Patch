...
function GunFire:auto()
  ...
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) and storage.totalAmmo >= 1 do
    ...
    util.wait(self.fireTime -
      (self.stances.motion1.duration + self.stances.motion2.duration + self.stances.motion3.duration + self.stances.motion4.duration + self.stances.motion5.duration + self.stances.motion6.duration + self.stances.motion7.duration + self.stances.motion8.duration + self.stances.motion9.duration + self.stances.motion10.duration))
...
function GunFire:reload()
  ...
  util.wait(self.stances.reloadmotion10.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress,
      self.stances.reloadmotion10.weaponRotation, self.stances.idle.weaponRotation))
