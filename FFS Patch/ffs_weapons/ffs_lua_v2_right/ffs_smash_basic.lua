...
function GunFire:auto()
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) do
    ...
    util.wait(self.fireTime -
      (self.stances.motion1.duration + self.stances.motion2.duration + self.stances.motion3.duration + self.stances.motion4.duration + self.stances.motion5.duration + self.stances.motion6.duration + self.stances.motion7.duration + self.stances.motion8.duration))
  end
