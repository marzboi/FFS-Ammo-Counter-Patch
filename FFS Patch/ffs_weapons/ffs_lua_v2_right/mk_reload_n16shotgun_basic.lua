...
function GunFire:auto()
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) and status.resource("energy") > 1 and  self.fireMode == (self.activatingFireMode or self.abilitySlot) and status.resource("energy") < 99 do
  ...
  while self.fireMode == (self.activatingFireMode or self.abilitySlot) and status.resource("energy") <= 99 do
  ...
  util.wait(self.stances.motion17.duration, function()
    ...
    self.weapon.relativeWeaponRotation = util.toRadians(interp.linear(progress, self.stances.motion17.weaponRotation, self.stances.motion10.weaponRotation))
    self.weapon.relativeArmRotation = util.toRadians(interp.linear(progress, self.stances.motion17.armRotation, self.stances.motion10.armRotation))
