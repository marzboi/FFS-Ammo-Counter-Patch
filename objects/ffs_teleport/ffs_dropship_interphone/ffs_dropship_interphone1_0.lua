...
function onInteraction(args)
  if config.getParameter("returnDoor") then
    ...
    return { "OpenTeleportDialog", {
        ...
        includePlayerBookmarks = false,
        destinations = { {
          name = "^orange;EP1 ^white;Automatic S.O.S from S.R.S",
          planetName = "I got an auto-emergency protocol.",
          icon = "ffs_1",
          warpAction = string.format("InstanceWorld:ffs1_0:%s:1", storage.uuid, world.threatLevel())
        } }
      }
    }
  end
